#Um aus den svg datein die polygonzüge (wall_points und wall_lines) zu extrahieren.
#  Um diese später als Goldlabel verwenden zu können. (für die genauigkeit sowie zeit)
